...
.grommet.#{$grommet-namespace}layer {
  position: relative;
  ...
  .#{$grommet-namespace}layer__container {
    ...
    @include media-query(lap-and-up) {
      position: absolute;
      max-height: 100%;
      min-width: 80%; //this bastard width//
      max-width: 80%;
      overflow: auto;
  ...
  &.#{$grommet-namespace}layer--align {
    &-center:not(.#{$grommet-namespace}layer--hidden) {
    ...
    &-left:not(.#{$grommet-namespace}layer--hidden) {
      .#{$grommet-namespace}layer__container {
        top: 0px;
        bottom: 0px;
        left: 0px;
    ...
    &-right:not(.#{$grommet-namespace}layer--hidden) {
      .#{$grommet-namespace}layer__container {
        top: 0px;
        bottom: 0px;
        right: 0px;
    ...
    &-top:not(.#{$grommet-namespace}layer--hidden) {
      @include media-query(lap-and-up) {
        .#{$grommet-namespace}layer__container {
          left: 50%;
    ...
    &-bottom:not(.#{$grommet-namespace}layer--hidden) {
      .#{$grommet-namespace}layer__container {
        bottom: 0px;
      }
    }
