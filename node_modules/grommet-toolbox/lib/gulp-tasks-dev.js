...
function devTasks(gulp, opts) {
  ...
  gulp.task('dev', ['dev-preprocess'], function () {
    ...
    var server = new _webpackDevServer2.default((0, _webpack2.default)(config), devServerConfig);
    ...
    server.listen(options.devServerPort || 8080, host, function (err) {
      if (err) {
        ...
        var openURL = protocol + '://' + openHost + ':' + options.devServerPort + '/webpack-dev-server/' + suffix;
