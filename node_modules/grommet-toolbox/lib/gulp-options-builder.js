...
function getOptions(opts) {
  if (!options) {
    ...
    var scssLoader = options.scssLoader || {
      test: /\.scss$/,
      loader: 'style!css!sass?outputStyle=expanded&' + 'includePaths[]=' + encodeURIComponent(_path2.default.resolve(options.base || process.cwd(), './node_modules')) + '&includePaths[]=' + encodeURIComponent(_path2.default.resolve(options.base || process.cwd(), './node_modules/grommet/node_modules'))
    };
